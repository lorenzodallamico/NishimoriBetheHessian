...
* The directory ```data``` contains two files (```featuresGAN.dat``` and ```featuresGAN_small.dat```) containing the features of 40k (resp. 6k) GAN images that can be used to test our algorithm.
